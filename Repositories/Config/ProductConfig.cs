        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
         ...
         new Product(){ProductId =5,CategoryId=2,    ImageUrl="/images/5.jpg", ProductName ="Deck", Price = 1_500, ShowCase = false},
          ...
          new Product(){ProductId =7,CategoryId=1,   ImageUrl="/images/7.jpg", ProductName ="Hamlet", Price = 45, ShowCase = false},
            new Product(){ProductId =8,CategoryId=2,   ImageUrl="/images/8.jpg", ProductName ="Camera", Price = 150, ShowCase = true },
            new Product(){ProductId =9,CategoryId=2,   ImageUrl="/images/9.jpg", ProductName ="Galaxy EF", Price = 11500, ShowCase = true},
            new Product(){ProductId =10,CategoryId=2,   ImageUrl="/images/10.jpg", ProductName ="Hp Mouse", Price = 535, ShowCase = true}
           );
        }
    }
}